...
public class xuv700_details extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_xuv700_details);
        Button bxuv700=findViewById(R.id.bookxuv700);
        Intent intent=getIntent();
        String em=intent.getStringExtra("email");
        bxuv700.setOnClickListener(view ->{
            Intent i4 = new Intent(getApplicationContext(),Booking.class);
            i4.putExtra("car","XUV 700");
            i4.putExtra("type","SUV");
            i4.putExtra("costperday","7500");
